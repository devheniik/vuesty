...
<template>
  <div class="relative mt-1 w-full">
    <button
      type="button"
      class="focus:border-indigo-500 focus:ring-indigo-500 relative h-8 w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:outline-none focus:ring-1 sm:text-sm"
