<template>
  <div class="container mx-auto h-screen space-y-9">
    ...
    <VToaster
      class="my-2"
      variant="danger"
      text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus et dolores sit nostrum nemo excepturi voluptatibus, saepe, dolorem corrupti magni, incidunt nesciunt officia qui facilis rem obcaecati facere exercitationem laudantium." />
  </div>
...
export default {
  name: 'App',
  components: { VInput, VToaster, AcademicCapIcon, VButton, VTable },
  data() {
    return {
      text: null,
    }
